...
```bash
git remote add encore encore://amapiano-ai-app-svsi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/amapiano-ai-app-svsi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/amapiano-ai-app-svsi/settings/integrations/github)
